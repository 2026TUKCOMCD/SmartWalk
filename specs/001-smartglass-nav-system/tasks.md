...
- [X] T004 [P] Create Dockerfile for Spring Boot application in backend/Dockerfile
...
### ESP32-CAM Setup
- [X] T009 [P] Create PlatformIO project structure in smartglass/platformio.ini
- [X] T010 [P] Configure ESP32-CAM board settings and dependencies in smartglass/platformio.ini
...
- [X] T018 [P] Configure Spring Security with Firebase token validation in backend/src/main/java/com/navblind/server/security/FirebaseAuthFilter.java
- [X] T019 [P] Create SecurityConfig with JWT bearer authentication in backend/src/main/java/com/navblind/server/config/SecurityConfig.java
- [X] T020 [P] Configure Redis connection and cache manager in backend/src/main/java/com/navblind/server/config/RedisConfig.java
...
- [X] T025 [P] Configure Retrofit API client with base URL — covered by AppModule.kt Retrofit provider
- [X] T026 [P] Setup Room database configuration in android/app/src/main/java/com/navblind/data/local/AppDatabase.kt
- [X] T027 [P] Create Firebase Auth wrapper service in android/app/src/main/java/com/navblind/service/auth/FirebaseAuthService.kt
...
- [X] T030 Create main.cpp with setup and loop structure in smartglass/src/main.cpp
- [X] T031 [P] Implement camera initialization in smartglass/src/camera.cpp
- [X] T032 [P] Implement Wi-Fi connection manager in smartglass/src/wifi_manager.cpp
...
- [X] T043 [US1] Implement route caching with Redis in backend/src/main/java/com/navblind/server/service/RouteCacheService.java
...
- [X] T051 [US1] Create GetNextInstructionUseCase in android/app/src/main/java/com/navblind/domain/usecase/GetNextInstructionUseCase.kt
...
### ESP32-CAM - US2
- [X] T058 [US2] Implement MJPEG streaming server in smartglass/src/wifi_stream.cpp
- [X] T059 [US2] Add HTTP endpoint for video stream /stream in smartglass/src/wifi_stream.cpp
- [X] T060 [US2] Implement WebSocket control channel for start/stop in smartglass/src/wifi_stream.cpp
...
- [X] T066 [US2] Implement ObjectTracker for multi-frame tracking in android/app/src/main/java/com/navblind/service/detection/ObjectTracker.kt
...
- [X] T068 [US2] Implement TrajectoryPredictor for collision risk in android/app/src/main/java/com/navblind/service/detection/TrajectoryPredictor.kt
- [X] T069 [US2] Implement HazardPrioritizer for alert ordering in android/app/src/main/java/com/navblind/service/detection/HazardPrioritizer.kt
...
### Backend - US4
- [X] T084 [P] [US4] Create SmartGlasses entity in backend/src/main/java/com/navblind/server/entity/SmartGlasses.java
- [X] T085 [P] [US4] Create SmartGlassesRepository interface in backend/src/main/java/com/navblind/server/repository/SmartGlassesRepository.java
- [X] T086 [P] [US4] Create Device DTOs (RegisterDeviceRequest, DeviceResponse) in backend/src/main/java/com/navblind/server/dto/DeviceDto.java
- [X] T087 [US4] Implement DeviceService in backend/src/main/java/com/navblind/server/service/DeviceService.java
- [X] T088 [US4] Create DeviceController with /devices endpoints in backend/src/main/java/com/navblind/server/controller/DeviceController.java

### ESP32-CAM - US4
- [X] T089 [US4] Implement AP mode for direct connection in smartglass/src/wifi_manager.cpp
- [X] T090 [US4] Implement STA mode for network connection in smartglass/src/wifi_manager.cpp
- [X] T091 [US4] Add device ID generation and broadcast in smartglass/src/main.cpp
- [X] T092 [US4] Implement connection status LED indicator in smartglass/src/main.cpp

### Android - US4
- [X] T093 [P] [US4] Create SmartGlasses domain model in android/app/src/main/java/com/navblind/domain/model/SmartGlasses.kt
- [X] T094 [P] [US4] Create DeviceApi Retrofit interface in android/app/src/main/java/com/navblind/data/remote/DeviceApi.kt
- [X] T095 [US4] Create DeviceRepository in android/app/src/main/java/com/navblind/domain/repository/DeviceRepository.kt
- [X] T096 [US4] Implement SmartGlassesConnectionService in android/app/src/main/java/com/navblind/service/streaming/SmartGlassesConnectionService.kt
- [X] T097 [US4] Implement auto-reconnection logic in SmartGlassesConnectionService
- [X] T098 [US4] Implement adaptive quality adjustment in ESP32CamStreamReceiver
- [X] T099 [US4] Create DeviceSettingsViewModel in android/app/src/main/java/com/navblind/presentation/settings/DeviceSettingsViewModel.kt
- [X] T100 [US4] Create DevicePairingScreen UI in android/app/src/main/java/com/navblind/presentation/settings/DevicePairingScreen.kt
- [X] T101 [US4] Add connection status voice announcements in SmartGlassesConnectionService
- [X] T101-A [US4] Implement battery status broadcast from ESP32-CAM in smartglass/src/battery.cpp
- [X] T101-B [US4] Add battery level receiver to SmartGlassesConnectionService in android/app/src/main/java/com/navblind/service/streaming/SmartGlassesConnectionService.kt
- [X] T101-C [US4] Add battery low voice warning in SmartGlassesConnectionService ("스마트글래스 배터리가 부족합니다")
...
- [X] T105 [US5] Implement VisualOdometryService using detected landmarks in android/app/src/main/java/com/navblind/service/location/VisualOdometryService.kt (선택적 개선 — spec FR-010은 GPS/ARCore/IMU만 요구, 필요 시 추가)
...
### Backend - US6
- [X] T111 [P] [US6] Create Preference entity in backend/src/main/java/com/navblind/server/entity/Preference.java
- [X] T112 [P] [US6] Create PreferenceRepository interface in backend/src/main/java/com/navblind/server/repository/PreferenceRepository.java
- [X] T113 [P] [US6] Create User/Preference DTOs in backend/src/main/java/com/navblind/server/dto/UserDto.java
- [X] T114 [US6] Implement UserService in backend/src/main/java/com/navblind/server/service/UserService.java
- [X] T115 [US6] Implement PreferenceService in backend/src/main/java/com/navblind/server/service/PreferenceService.java
- [X] T116 [US6] Create AuthController with /auth/verify endpoint in backend/src/main/java/com/navblind/server/controller/AuthController.java
- [X] T117 [US6] Create UserController with /users/me endpoints in backend/src/main/java/com/navblind/server/controller/UserController.java
- [X] T118 [US6] Add CRUD endpoints to DestinationController in backend/src/main/java/com/navblind/server/controller/DestinationController.java
- [X] T119 [US6] Implement session caching in Redis in backend/src/main/java/com/navblind/server/service/SessionCacheService.java
- [X] T120 [US6] Implement preference caching in Redis in PreferenceService

### Android - US6
- [X] T121 [P] [US6] Create LocalDestination Room entity in android/app/src/main/java/com/navblind/data/local/entity/LocalDestination.kt
- [X] T122 [P] [US6] Create LocalPreference Room entity in android/app/src/main/java/com/navblind/data/local/entity/LocalPreference.kt
- [X] T123 [P] [US6] Create DestinationDao interface in android/app/src/main/java/com/navblind/data/local/dao/DestinationDao.kt
- [X] T124 [P] [US6] Create PreferenceDao interface in android/app/src/main/java/com/navblind/data/local/dao/PreferenceDao.kt
- [X] T125 [P] [US6] Create UserApi Retrofit interface in android/app/src/main/java/com/navblind/data/remote/UserApi.kt
- [X] T126 [P] [US6] Create AuthApi Retrofit interface in android/app/src/main/java/com/navblind/data/remote/AuthApi.kt
- [X] T127 [US6] Create UserRepository in android/app/src/main/java/com/navblind/domain/repository/UserRepository.kt
- [X] T128 [US6] Implement UserRepositoryImpl with local+remote sync in android/app/src/main/java/com/navblind/data/repository/UserRepositoryImpl.kt
- [X] T129 [US6] Create DestinationRepositoryImpl with sync in android/app/src/main/java/com/navblind/data/repository/DestinationRepositoryImpl.kt
- [X] T130 [US6] Create LoginUseCase in android/app/src/main/java/com/navblind/domain/usecase/LoginUseCase.kt
- [X] T131 [US6] Create SaveDestinationUseCase in android/app/src/main/java/com/navblind/domain/usecase/SaveDestinationUseCase.kt
- [X] T132 [US6] Create UpdatePreferencesUseCase in android/app/src/main/java/com/navblind/domain/usecase/UpdatePreferencesUseCase.kt
- [X] T133 [US6] Implement VoiceGuidedRegistrationService in android/app/src/main/java/com/navblind/service/voice/VoiceGuidedRegistrationService.kt
- [X] T134 [US6] Create AuthViewModel in android/app/src/main/java/com/navblind/presentation/auth/AuthViewModel.kt
- [X] T135 [US6] Create LoginScreen with voice guidance in android/app/src/main/java/com/navblind/presentation/auth/LoginScreen.kt
- [X] T136 [US6] Create SettingsViewModel in android/app/src/main/java/com/navblind/presentation/settings/SettingsViewModel.kt
- [X] T137 [US6] Create PreferencesScreen (voice-accessible) in android/app/src/main/java/com/navblind/presentation/settings/PreferencesScreen.kt
- [X] T138 [US6] Create SavedDestinationsScreen in android/app/src/main/java/com/navblind/presentation/settings/SavedDestinationsScreen.kt
...
### ESP32-CAM Polish
- [X] T139 [P] Add battery percentage estimation algorithm in smartglass/src/battery.cpp (enhancement to T101-A)
- [X] T140 [P] Add multiple battery warning levels (50%, 20%, 10%) in smartglass/src/battery.cpp
- [X] T141 Implement power-saving mode when idle in smartglass/src/main.cpp

### Android Polish
- [X] T142 [P] Implement offline mode detection and handling in android/app/src/main/java/com/navblind/service/NetworkStateService.kt
- [ ] T143 [P] Add battery optimization for background services in android/app/src/main/java/com/navblind/service/
- [X] T144 [P] Implement accessibility service integration in android/app/src/main/java/com/navblind/service/AccessibilityService.kt
- [X] T145 Create main app navigation graph in android/app/src/main/java/com/navblind/presentation/NavGraph.kt
- [X] T146 Add vibration feedback for alerts in ObstacleAlertService
- [X] T147 Implement multi-hazard priority queue announcement in ObstacleAlertService

### Backend Polish
- [X] T148 [P] Add request rate limiting in backend/src/main/java/com/navblind/server/config/RateLimitConfig.java
- [X] T149 [P] Add structured logging configuration in backend/src/main/resources/logback-spring.xml
- [X] T150 [P] Add API documentation with SpringDoc OpenAPI in backend/src/main/java/com/navblind/server/config/OpenApiConfig.java

### Infrastructure Polish
- [X] T151 [P] Create docker-compose.prod.yml for production in docker/docker-compose.prod.yml
- [X] T152 [P] Add SSL certificate configuration to Nginx in docker/nginx/nginx-ssl.conf
- [X] T153 Create deployment documentation in docs/deployment.md
