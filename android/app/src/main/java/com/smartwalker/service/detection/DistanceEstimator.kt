...
class DistanceEstimator @Inject constructor() {
     ...
     * 객체의 상대적 방향을 계산합니다.
     */
    fun calculateRelativeDirection(boundingBox: RectF): com.smartwalker.domain.model.RelativeDirection {
        ...
        return when {
            offsetRatio < -0.5f -> com.smartwalker.domain.model.RelativeDirection.LEFT
            offsetRatio < -0.15f -> com.smartwalker.domain.model.RelativeDirection.SLIGHTLY_LEFT
            offsetRatio > 0.5f -> com.smartwalker.domain.model.RelativeDirection.RIGHT
            offsetRatio > 0.15f -> com.smartwalker.domain.model.RelativeDirection.SLIGHTLY_RIGHT
            else -> com.smartwalker.domain.model.RelativeDirection.CENTER
        }
    }
    ...
    private fun calculateDangerLevel(obj: DetectedObject, distance: Float?): Float {
        ...
        val positionWeight = when (obj.relativeDirection) {
            com.smartwalker.domain.model.RelativeDirection.CENTER -> 1.2f
            com.smartwalker.domain.model.RelativeDirection.SLIGHTLY_LEFT,
            com.smartwalker.domain.model.RelativeDirection.SLIGHTLY_RIGHT -> 1.0f
            com.smartwalker.domain.model.RelativeDirection.LEFT,
            com.smartwalker.domain.model.RelativeDirection.RIGHT -> 0.7f
        }
